        ...
        <div className="lg:w-[45%] flex flex-col gap-4">
          ...
          <div className="bg-[#111827] border border-indigo-900/60 rounded-xl overflow-hidden">
            ...
            <div className="p-4">
              ...
              {/* Hint request button — not shown in worked_example_first or step_by_step_scaffold mode */}
              {supportStrategy !== "worked_example_first" && supportStrategy !== "step_by_step_scaffold" && !hintVisible && !shouldShowHintInitially && feedback === null && !showWorkedExample && (
                <button
